...
const GithubIcon = () => (
  <svg height="1.2em" viewBox="0 0 24 24" fill="#fff" style={{verticalAlign: 'middle', marginRight: '0.4em'}}>
...
const Contact: React.FC = () => (
  <section className="contact">
    ...
    <p>📞 092-802-9402</p>
    <p>✉️ <a href="mailto:anawat.pumunkid@gmail.com">anawat.pumunkid@gmail.com</a></p>
    <p>
      <a
        href="https://github.com/GunDeTama"
        target="_blank"
        rel="noopener noreferrer"
        style={{ display: 'inline-flex', alignItems: 'center', color: '#40a9ff', fontWeight: 500 }}
      >
        <GithubIcon />
        github.com/GunDeTama
      </a>
    </p>
  </section>
);
